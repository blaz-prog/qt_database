...
class AlchemyTableModel(qtc.QAbstractTableModel):

    def __init__(self, session, delojemalec):
        super().__init__()
        self.dirty = False
        self.db_session = session
        self.record_list = delojemalec.otroci
        self.fields_headers = Otrok.FIELDS_HEADERS
